...
#' @param type Required; The type of historical data to return, including tick data, minute data, and end-of-day data.
...
#' @param jerq optional; Whether to merge with JERQ data.
#' @param exchange optional; The list of valid exchange codes to limit symbol search.
...
getHistory <- function(symbol, type, startDate = NULL, endDate = NULL, maxRecords = '1000000',
                       ...
                       dividends = 1, volume = 'total', nearby = 1, jerq = 1,
